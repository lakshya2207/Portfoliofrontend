  ...
  return (
    <div className="absolute h-[calc(100dvh)] w-[calc(100dvw)] bg-[url('/wallpaper.jpg')] bg-cover bg-center">
      ...
      <div className="absolute top-0 left-0 p-2 grid grid-cols-1 gap-4">
        ...
        <button
          onClick={() => window.open(intro.github, "_blank")}
          className="flex flex-col items-center"
        >
        ...
        <button
          onClick={() => window.open(intro.linkedin, "_blank")}
          className="flex flex-col items-center"
        >
          <img
        ...
        <button
          onClick={() => window.open(intro.resume, "_blank")}
          className="flex flex-col items-center"
        >
      ...
      <div className="absolute bottom-0 left-0 w-full bg-gray-800  flex justify-between items-center">
        <div className="flex">
          ...
          >
            <img
              className="h-8 w-8  brightness-200 contrast-more:"
              src="./images/logo.png"
              alt="winlogo"
            />
          </button>
          ...
          <div className="flex ">
            ...
            <div className="flex space-x-1">
              ...
              {minimizedWindows.FileExplorer && (
                <button
                  onClick={() => maximizeWindow("FileExplorer")}
                  className=" text-white bg-slate-600 p-2 px-3 hover:bg-gray-500"
                >
                  <img className="w-6" src="../images/file.png" alt="" />
                </button>
              )}
              {minimizedWindows.Projects && (
                <button
                  ...
                  className=" text-white bg-slate-600 p-2 px-3 hover:bg-gray-500"
                >
                  <img className="w-6" src="../images/projects.png" alt="" />
                </button>
              )}
              {minimizedWindows.Contactme && (
                <button
                  onClick={() => maximizeWindow("Contactme")}
                  className=" text-white bg-slate-600 p-2 px-3 hover:bg-gray-500"
                >
                  <img className="w-6" src="../images/contact.png" alt="" />
                </button>
              )}
              {minimizedWindows.GitHub && (
                <button
                  onClick={() => maximizeWindow("GitHub")}
                  className="text-white bg-slate-600 p-2 px-3 hover:bg-gray-500"
                >
                  <img className="w-6" src="./images/github.png" alt="" />
                </button>
              )}
            </div>
          </div>
