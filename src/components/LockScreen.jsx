...
const LockScreen = () => {
  ...
  return (
    <>
      <div className='lockscreen absolute bg-[url("https://mrwallpaper.com/images/hd/4k-ultra-hd-windows-forest-artwork-3vcnu451trkacmcd.jpg")] bg-cover bg-center flex blur-[2px] justify-items-center items-center h-screen w-screen'>
      </div>
      <div className='h-screen absolute w-screen content-center text-center'>
